            ...
            <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3 '>
                ...
                <div className='flex flex-col gap-1 w-[85%] items-start justify-center px-3 relative'>
                 ...
                 <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
                  ...
                  <span className={`px-[10px] py-[5px] border-[1px] border-[#e7e6e6] rounded-2xl  cursor-pointer ${role === 'admin' ? "border-black" : "border-[#646464]"}`}  onClick={()=>setRole("admin")}>Admin</span>
                </div>
                ...
                <div className='w-[80%] h-[40px] border-1 border-[black] rounded-[5px] flex items-center justify-center  ' onClick={googleSignUp} ><img src={google} alt="" className='w-[25px]' /><span className='text-[18px] text-gray-500'>google</span> </div>
