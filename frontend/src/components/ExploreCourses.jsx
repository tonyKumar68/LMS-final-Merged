  ...
  return (
    <div className='w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]'>
        <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px]  flex flex-col items-start justify-center gap-1 md:px-[40px]  px-[20px]'>
          ...
          <p className='text-[17px]'> Our LMS portal offers a variety of exciting courses across subjects like technology and more. Each course is created to make learning simple with videos, quizzes, and hands-on activities to help you understand better..</p>
